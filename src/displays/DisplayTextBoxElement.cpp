/**
 * @file DisplayTextBoxElement.cpp
 * @brief Output Element for controlling a text output on a pixel display including border and background.
 *
 ...
 *
 * Changelog, see DisplayTextBoxElement.h.
 */
...
/**
 * @brief static factory function to create a new DisplayTextBoxElement.
 * @return DisplayTextBoxElement* as Element* created element
 */
Element *DisplayTextBoxElement::create() {
  return (new DisplayTextBoxElement());
}  // create()
 ...
 */
bool DisplayTextBoxElement::set(const char *name, const char *value) {
  bool ret = true;
 ...
 */
void DisplayTextBoxElement::start() {
  TRACE("start()");
