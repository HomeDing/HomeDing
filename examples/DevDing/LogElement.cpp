/**
 * @file LogElement.cpp
 * @brief Log Element Template class.
 *
...
// available Elements. See <HomeDing.h> the move these lines to LogElement.h:

// #ifdef HOMEDING_REGISTER
// Register the LogElement onto the ElementRegistry.
